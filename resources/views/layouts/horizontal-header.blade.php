<nav class="navbar navbar-expand-xl container-fluid p-0">
  <ul class="navbar-nav align-items-center">
    ...
    <li class="nav-item d-none d-xl-block">
      <a href="{{ route('dashboard') }}" class="text-nowrap nav-link">
        <img src="{{ URL::asset('images/logos/logo-dark.svg') }}" class="dark-logo" alt="modernize-img" height="35" />
        <img src="{{ URL::asset('images/logos/logo-light.svg') }}" class="light-logo" alt="modernize-img" height="35" />
      </a>
    </li>
  ...
  <div class="d-block d-xl-none">
    <a href="{{ route('dashboard') }}" class="text-nowrap nav-link">
      <img src="{{ URL::asset('images/logos/logo-dark.svg') }}" alt="modernize-img" height="30" />
    </a>
  </div>
