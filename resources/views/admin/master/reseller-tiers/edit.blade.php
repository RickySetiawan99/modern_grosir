        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
            <div>
                <div class="d-flex align-items-center gap-2 mb-1">
                    ...
                    <span class="text-muted fs-2">&bull; Edit Data Tier</span>
                </div>
                <h3 class="fw-bold mb-1 text-dark">Edit Reseller Tier</h3>
                <p class="text-muted mb-0 fs-3">Perbarui informasi tingkatan reseller yang sudah ada.</p>
            </div>
        </div>
    </div>
</div>
