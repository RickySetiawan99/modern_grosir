...
@section('title', config('app.name', 'ModernGrosir') . ' - Product Categories')
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
            <div>
                <div class="d-flex align-items-center gap-2 mb-1">
                    ...
                    <span class="text-muted fs-2">&bull; Pengelompokan Produk</span>
                </div>
                <h3 class="fw-bold mb-1 text-dark">Kategori Produk</h3>
                <p class="text-muted mb-0 fs-3">Atur dan kelola kategori untuk pengelompokan barang dagangan.</p>
            </div>
            <div class="d-flex align-items-center gap-2 flex-shrink-0">
                <a href="{{ route('master.categories.create') }}" class="btn btn-primary px-3.5 py-2 rounded-3 d-flex align-items-center gap-2 shadow-sm fw-medium">
