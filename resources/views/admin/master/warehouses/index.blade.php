...
@section('title', 'ModernGrosir - Warehouses')
...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
  <div class="card-body px-4 py-3">
    <div class="row align-items-center">
      <div class="col-9">
        <h4 class="fw-semibold mb-8">Warehouses</h4>
...
<div class="card">
  <div class="card-body">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h5 class="card-title fw-semibold">Warehouses List</h5>
      <div class="d-flex gap-2">
        ...
        <a href="{{ route('master.warehouses.create') }}" class="btn btn-sm btn-primary">
          <i class="ti ti-plus fs-3 me-2"></i> Add New Warehouse
        </a>
      </div>
    </div>
